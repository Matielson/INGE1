...
**Título:** Como usuario quiero reservar un hospedaje para hospedarme.
...
**CUANDO** el usuario ingresa la fecha de ingreso `08/05/26`, fecha de egreso `18/05/26`, hotel `Hotel del Rey`, `5` personas hospedadas y presiona **"Reservar"**.  
...
**CUANDO** el usuario ingresa la fecha de ingreso `12/12/26`, fecha de egreso `17/12/26`, hotel `Gran Brizo`, `4` personas hospedadas y presiona **"Reservar"**.  
**ENTONCES** no se efectúa la reserva y se informa: **"Reserva fallida, fecha de ingreso mayor a 90 días de la fecha actual."**
...
**CUANDO** el usuario ingresa la fecha de ingreso `04/09/26`, fecha de egreso `20/10/26`, hotel `Hotel del Rey`, `2` personas hospedadas y presiona **"Reservar"**.  
**ENTONCES** no se efectúa la reserva y se informa: **"Reserva fallida, estadía superior a 15 días."**
...
**ID:** Check In  
**Título:** Como usuario quiero realizar el check in para hospedarme.
...
**ENTONCES** el sistema informa la habitación asignada, envía un mensaje a alguno de los conserjes del hotel para que guíe al usuario hasta la habitación y otro mensaje a los botones para que se hagan cargo de las valijas.
...
### Escenario 3 — Check In fallido por horario

**DADO** que el check in no se realiza entre las 10:00 y las 23:59.  
**CUANDO** el usuario intenta realizar el Check In.  
**ENTONCES** el sistema informa: **"Aún no se encuentran habilitados los ingresos al hotel."**
...
**ID:** Check Out  
**Título:** Como conserje quiero hacer el check out de una habitación para que pueda ser reservada.
