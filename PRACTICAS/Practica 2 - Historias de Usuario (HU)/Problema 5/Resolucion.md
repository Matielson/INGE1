...
**ID:** Registro Usuario  
**Título:** Como empleado quiero registrarme en el sistema para solicitar una licencia.
...
**ENTONCES** el sistema registra el usuario e informa: **"Registro exitoso."**

### Escenario 2 — Registro fallido por usuario ya registrado

**DADO** un nombre de usuario ya registrado y una contraseña.  
**CUANDO** el empleado ingresa el nombre de usuario `"Pepe123"` y la contraseña `"Sos12345"`.  
**ENTONCES** el sistema no registra el usuario e informa: **"Registro fallido, usuario ya registrado."**
...
**ID:** Inicio Sesión  
**Título:** Como empleado quiero iniciar sesión en el sistema para solicitar una licencia.

### Escenario 1 — Inicio exitoso

**DADO** un nombre de usuario y contraseña registrados en el sistema.  
**CUANDO** el empleado ingresa el nombre de usuario `"Pepe123"` y la contraseña `"Sos12345"`.  
**ENTONCES** el sistema inicia sesión e informa: **"Inicio de sesión exitoso."**

### Escenario 2 — Inicio fallido por usuario incorrecto

**DADO** un nombre de usuario no registrado en el sistema y una contraseña.  
**CUANDO** el empleado ingresa el nombre de usuario `"Pepe123"` y la contraseña `"Sos12345"`.  
**ENTONCES** el sistema no inicia sesión e informa: **"Datos incorrectos."**
...
**ID:** Cierre Sesión  
**Título:** Como empleado quiero cerrar sesión para finalizar mi sesión en el sistema.
...
**Título:** Como empleado quiero solicitar una licencia para justificar el ausente.
...
**ENTONCES** el sistema registra la solicitud e informa: **"Solicitud exitosa."**
...
**ENTONCES** el sistema no registra la solicitud e informa: **"Solicitud fallida por antigüedad insuficiente."**
...
**Título:** Como administrativo quiero consultar las licencias solicitadas para ver el informe de los ausentes.
...
**CUANDO** el administrativo ingresa el CUIL del empleado `20-55555555-5`, un rango de fechas `08-08-26` hasta `08-09-26` y presiona **"Consultar informe"**.  
...
**CUANDO** el administrativo ingresa el CUIL del empleado `20-55555555-5`, un rango de fechas `08-08-26` hasta `08-09-26` y presiona **"Consultar informe"**.  
**ENTONCES** el sistema informa: **"CUIL no registrado como empleado."**
...
**CUANDO** el administrativo ingresa el CUIL del empleado `20-55555555-5`, un rango de fechas `08-08-26` hasta `08-09-26` y presiona **"Consultar informe"**.  
**ENTONCES** el sistema informa: **"Informe ya solicitado este mes."**
