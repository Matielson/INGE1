...
**ID:** Inicio Sesión  
**Título:** Como persona quiero iniciar sesión para comprar bebidas.
...
**ENTONCES** la sesión no es iniciada y el sistema muestra en pantalla: **"Datos incorrectos."**
...
**Título:** Como usuario quiero seleccionar una bebida para hacer una compra.
...
**ID:** Comprar Bebidas  
**Título:** Como usuario quiero comprar las bebidas seleccionadas para conocer el monto de los productos elegidos.
